...
//
// Solidity: function updateTx(bytes tx, uint256 tx_from, uint256 tx_to, uint256 tx_amount, bytes proof_from, bytes proof_to) returns()
func (_Rollup *RollupTransactor) UpdateTx(opts *bind.TransactOpts, tx []byte, tx_from *big.Int, tx_to *big.Int, tx_amount *big.Int, proof_from []byte, proof_to []byte) (*types.Transaction, error) {
	return _Rollup.contract.Transact(opts, "updateTx", tx, tx_from, tx_to, tx_amount, proof_from, proof_to)
}

// UpdateTx is a paid mutator transaction binding the contract method 0x2cb79e21.
//
// Solidity: function updateTx(bytes tx, uint256 tx_from, uint256 tx_to, uint256 tx_amount, bytes proof_from, bytes proof_to) returns()
func (_Rollup *RollupSession) UpdateTx(tx []byte, tx_from *big.Int, tx_to *big.Int, tx_amount *big.Int, proof_from []byte, proof_to []byte) (*types.Transaction, error) {
	return _Rollup.Contract.UpdateTx(&_Rollup.TransactOpts, tx, tx_from, tx_to, tx_amount, proof_from, proof_to)
}

// UpdateTx is a paid mutator transaction binding the contract method 0x2cb79e21.
//
// Solidity: function updateTx(bytes tx, uint256 tx_from, uint256 tx_to, uint256 tx_amount, bytes proof_from, bytes proof_to) returns()
func (_Rollup *RollupTransactorSession) UpdateTx(tx []byte, tx_from *big.Int, tx_to *big.Int, tx_amount *big.Int, proof_from []byte, proof_to []byte) (*types.Transaction, error) {
	return _Rollup.Contract.UpdateTx(&_Rollup.TransactOpts, tx, tx_from, tx_to, tx_amount, proof_from, proof_to)
}
