...
// ApplyTx is a free data retrieval call binding the contract method 0x8528b01b.
//
// Solidity: function ApplyTx(TypesAccountMerkleProof _merkle_proof, TypesTransaction transaction) view returns(TypesUserAccount updatedAccount, bytes32 newRoot)
func (_Rollup *RollupCaller) ApplyTx(opts *bind.CallOpts, _merkle_proof TypesAccountMerkleProof, transaction TypesTransaction) (struct {
	UpdatedAccount TypesUserAccount
	NewRoot        [32]byte
}, error) {
	ret := new(struct {
		UpdatedAccount TypesUserAccount
	...
	out := ret
	err := _Rollup.contract.Call(opts, out, "ApplyTx", _merkle_proof, transaction)
	return *ret, err
}
...
//
// Solidity: function ApplyTx(TypesAccountMerkleProof _merkle_proof, TypesTransaction transaction) view returns(TypesUserAccount updatedAccount, bytes32 newRoot)
func (_Rollup *RollupSession) ApplyTx(_merkle_proof TypesAccountMerkleProof, transaction TypesTransaction) (struct {
	UpdatedAccount TypesUserAccount
	NewRoot        [32]byte
}, error) {
	return _Rollup.Contract.ApplyTx(&_Rollup.CallOpts, _merkle_proof, transaction)
}

// ApplyTx is a free data retrieval call binding the contract method 0x8528b01b.
//
// Solidity: function ApplyTx(TypesAccountMerkleProof _merkle_proof, TypesTransaction transaction) view returns(TypesUserAccount updatedAccount, bytes32 newRoot)
func (_Rollup *RollupCallerSession) ApplyTx(_merkle_proof TypesAccountMerkleProof, transaction TypesTransaction) (struct {
	UpdatedAccount TypesUserAccount
	NewRoot        [32]byte
}, error) {
	return _Rollup.Contract.ApplyTx(&_Rollup.CallOpts, _merkle_proof, transaction)
...
// ProcessBatch is a free data retrieval call binding the contract method 0x9a4a4470.
//
...
// ProcessTx is a free data retrieval call binding the contract method 0xbdd80b71.
//
// Solidity: function processTx(bytes32 _balanceRoot, bytes32 _accountsRoot, TypesTransaction _tx, TypesPDAMerkleProof _from_pda_proof, TypesAccountProofs accountProofs) view returns(bytes32, uint256, uint256, bool)
func (_Rollup *RollupCaller) ProcessTx(opts *bind.CallOpts, _balanceRoot [32]byte, _accountsRoot [32]byte, _tx TypesTransaction, _from_pda_proof TypesPDAMerkleProof, accountProofs TypesAccountProofs) ([32]byte, *big.Int, *big.Int, bool, error) {
	var (
		ret0 = new([32]byte)
		ret1 = new(*big.Int)
		ret2 = new(*big.Int)
	...
	err := _Rollup.contract.Call(opts, out, "processTx", _balanceRoot, _accountsRoot, _tx, _from_pda_proof, accountProofs)
...
//
// Solidity: function processTx(bytes32 _balanceRoot, bytes32 _accountsRoot, TypesTransaction _tx, TypesPDAMerkleProof _from_pda_proof, TypesAccountProofs accountProofs) view returns(bytes32, uint256, uint256, bool)
func (_Rollup *RollupSession) ProcessTx(_balanceRoot [32]byte, _accountsRoot [32]byte, _tx TypesTransaction, _from_pda_proof TypesPDAMerkleProof, accountProofs TypesAccountProofs) ([32]byte, *big.Int, *big.Int, bool, error) {
	return _Rollup.Contract.ProcessTx(&_Rollup.CallOpts, _balanceRoot, _accountsRoot, _tx, _from_pda_proof, accountProofs)
}

// ProcessTx is a free data retrieval call binding the contract method 0xbdd80b71.
//
// Solidity: function processTx(bytes32 _balanceRoot, bytes32 _accountsRoot, TypesTransaction _tx, TypesPDAMerkleProof _from_pda_proof, TypesAccountProofs accountProofs) view returns(bytes32, uint256, uint256, bool)
func (_Rollup *RollupCallerSession) ProcessTx(_balanceRoot [32]byte, _accountsRoot [32]byte, _tx TypesTransaction, _from_pda_proof TypesPDAMerkleProof, accountProofs TypesAccountProofs) ([32]byte, *big.Int, *big.Int, bool, error) {
	return _Rollup.Contract.ProcessTx(&_Rollup.CallOpts, _balanceRoot, _accountsRoot, _tx, _from_pda_proof, accountProofs)
}
...
// DisputeBatch is a paid mutator transaction binding the contract method 0x84c16e0d.
//
